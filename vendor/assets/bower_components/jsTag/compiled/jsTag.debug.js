...
jsTag.factory('JSTagsCollection', ['JSTag', '$filter', '$rootScope', function(JSTag, $filter, $rootScope) {
  ...
  JSTagsCollection.prototype.addTag = function(value) {
    ...
    if (regex.test(value)) { 
      ...
      $rootScope.$emit('tagAdded', value);
    } else {
      $rootScope.$emit('formatError', newTag);
    };
