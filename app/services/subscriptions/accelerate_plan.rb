module Subscriptions
  class AcceleratePlan
    ...
    def floor_price
      ...
      properties[:prices][:floor_price].presence || 4.0
    end

    def total_discount
      return 8.0 unless properties[:prices].present?

      properties[:prices][:total_discount].presence || 8.0
    end
    ...
    def functionalities_template
      { tracking_page: 'default', better_sla_algorithm: 'default' }
    end
    ...
    def configurations_template
      { users: 3, shipments: 2, apps_slots: 4 }
    end
