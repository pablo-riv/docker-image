module Subscriptions
  class EnterprisePlan
    ...
    def floor_price
      return 5.0 unless properties[:prices].present?

      properties[:prices][:floor_price].presence || 5.0
    end

    def total_discount
      return 3.0 unless properties[:prices].present?

      properties[:prices][:total_discount].presence || 3.0
    end
    ...
    def configurations_template
      { users: 4, shipments: 3, couriers: 0, apps_slots: 3 }
    end
